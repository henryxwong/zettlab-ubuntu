...
1. **Create the Directory Structure**:
    ...
    - Inside it, create `docker-compose.yml` with the following content:
      ```yaml
      services:
        ubuntu:
          image: ubuntu:24.04
          ...
          volumes:
            - /This_NAS/Teams/docker/ubuntu:/root
...
3. **Start the Container**:
    - Use the NAS Docker UI to create and start the container from the compose file.
